...
static class $Inner1 {
    ...
    static final int[] $SwitchMap$CustomEnum;

    static {
        $SwitchMap$CustomEnum = new int[CustomEnum.values().length];
        $SwitchMap$CustomEnum[CustomEnum.ONE.ordinal()] = 1;
        $SwitchMap$CustomEnum[CustomEnum.TWO.ordinal()] = 2;
        $SwitchMap$CustomEnum[CustomEnum.THREE.ordinal()] = 3;
    }
}
----
...
[source,java]
----
switch($Inner1.$SwitchMap$CustomEnum[a.ordinal()]) {
    case 1:
        System.out.println("one");
        break;
    case 2:
